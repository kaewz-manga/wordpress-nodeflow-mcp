...
const plans = [
  {
    ...
    price: 0,
    requests: 1000,
    features: ['1 API key', '10 req/min', 'Community support'],
  },
  {
    tier: 'starter',
    name: 'Starter',
    price: 9,
    requests: 10000,
    features: ['5 API keys', '30 req/min', 'Email support', 'Webhooks'],
  },
  {
    tier: 'pro',
    name: 'Pro',
    price: 29,
    requests: 50000,
    features: ['Unlimited API keys', '100 req/min', 'Priority support', 'Team management', 'SLA reports'],
    popular: true,
  },
  {
    tier: 'business',
    ...
    price: 99,
    requests: 200000,
    features: ['Everything in Pro', '300 req/min', 'Dedicated support', 'Custom domains', 'Audit logs'],
  },
];
